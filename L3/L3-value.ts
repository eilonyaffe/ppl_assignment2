...
export const isClassSExp = (x: any): x is ClassSExp => x.tag === "Class";
// ========================================================
...
export const makeObject = (cl: ClassSExp): Object => 
    ({tag: "Object", classType: cl, env : makeEmptyEnv()});
export const makeObjectEnv = (cl: ClassSExp, env: Env): Object =>
    ({tag: "Object", classType: cl, env: env});
...
export type SExpValue = number | boolean | string | PrimOp | Closure | SymbolSExp | EmptySExp | CompoundSExp | ClassSExp | Object; 
...
export const classToString = (c: ClassSExp): string =>
   `Class`
